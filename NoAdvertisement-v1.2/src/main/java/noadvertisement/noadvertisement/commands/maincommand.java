    ...
    public boolean onCommand(CommandSender sender,Command command,String label, String[] args) {
        ...
        else if(args.length==1)
        {
            ...
            if(arg_to_string.equals("help"))
            {
                ...
                sender.sendMessage(ChatColor.YELLOW+"[Noadvertisement]"+ChatColor.GREEN+" /Noadvertisement help - 插件帮助");
                sender.sendMessage(ChatColor.YELLOW+"[Noadvertisement]"+ChatColor.GREEN+" /Noadvertisement add w <网址> - 添加白名单");
                sender.sendMessage(ChatColor.YELLOW+"[Noadvertisement]"+ChatColor.GREEN+" /Noadvertisement add b <网址> - 添加黑名单");
            }
            ...
            else if(arg_to_string.equals("clear"))
            {
        ...
        {
            String arg_to_string = args[0];
            if(sender.hasPermission("noadvertisement.command.add")) {
